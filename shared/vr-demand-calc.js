/* =============================================================================
   ...
   V2  each year gets its own demand:
         ...
         OM  a Treasury NATIONAL forecast apportioned by the region's
             3-year-average share of national. Not ABS actuals.
   ...
   computeDemand({ components, population, national, treasuryNom, wf, params })
     ...
     national    { nom:{YYYY:n} }  national NOM history, for the share
     treasuryNom { yr1:n, yr2:n }  national NOM forecast levels
...
(function (root) {
  ...
  const DEFAULT_PARAMS = {
    ...
    nomShareWindowYears: 3,    // window for the region's share of national NOM
  ...
  function computeDemand(inp) {
    ...
    // Region's share of national overseas migration, on the same window.
    const nomShare = (nomAvg3 != null && natNomAvg3) ? nomAvg3 / natNomAvg3 : null;
    const tr = o.treasuryNom || {};
    const om1 = (nomShare != null && num(tr.yr1) != null) ? num(tr.yr1) * nomShare : null;
    const om2 = (nomShare != null && num(tr.yr2) != null) ? num(tr.yr2) * nomShare : null;
    ...
    /* ── V1 — 2-year averages, both years identical ──────────────────────── */
    let v1 = null;
    if (niAvg2 != null && imAvg2 != null && om1 != null) {
      // year 2 repeats year 1 wholesale — the year-2 workforce figure is
      // deliberately not applied, matching the workbook
      v1 = Object.assign(pack(niAvg2, imAvg2, om1, niAvg2, imAvg2, om1), { repeatYr2: true });
      v1.im2 = v1.im1; v1.people2 = v1.people1; v1.people2NoWf = v1.people1NoWf; v1.wf2 = wf1;
    }
    ...
    return {
      v1, v2,
      inputs: { latestYear: latest, population: pop, niAvg2, niAvg3, imAvg2, imAvg3, imCur, nomAvg3, natNomAvg3, nomShare, wf1, wf2, params: P },
    };
  }
